...
vipro = LINETCR.LINE()
#vipro.login(qr=True)
vipro.login(token='Es3M8wyMYV1NpyyE0Cm2.S7/Pin4l6IFgnbXXp+O8KG.z712Yisx5RzAq71vNwE9z5lstODH8KXG419FE7eKykw=')
vipro.loginResult()
...
╚═════════════════════════
"""
vip="ub3bfa920de0bea27c6341c713ffa3c92"
...
Bots=[mid]
Creator=["ub3bfa920de0bea27c6341c713ffa3c92"]
admin=["ub3bfa920de0bea27c6341c713ffa3c92"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment":"Bot Auto Like ©By : Enesbyrk\nContact Me : 👉 line.me/ti/p/zG9N59LIus",    
    "commentOn":True,
    "commentBlack":{},
...
#                            Name = summon(op.param2)
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     contact = vipro.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["OTORESPON:konu önemliyse lütfen özele yazın"]
                     ret_ = random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
		...
		if msg.from_ in Creator:
                    for i in gid:
                        h = vipro.getGroup(i).name
		        if h == ng:
			    vipro.sendText(i,"Grubumuza hoşgeldin")
		            vipro.leaveGroup(i)
		...
		if midd not in admin:
		    ...
		    vipro.sendText(msg.to,"Admin Detected")
                ...
                midd = "ub3bfa920de0bea27c6341c713ffa3c92"
                vipro.inviteIntoGroup(msg.to,[midd])
		...
		if msg.from_ in Creator:
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
                msg.contentType = 13
                msg.contentMetadata = {'mid': "Enesbyrk,'"}
                vipro.sendMessage(msg)
